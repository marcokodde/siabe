                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 mb-3">
                                    <label class="form-label font-w600" for="child_id">CHILD ID<span class="text-danger scale5 ms-2">*</span></label>
                                    <input type="text" class="form-control solid" placeholder="CHILD ID" aria-label="child_id" id="child_id" name="child_id" value="{{ $child->child_id }}">
                                </div>
                                <div class="col-md-6 col-lg-6 mb-3">
                                    <label class="form-label font-w600" for="subproject_id">Subproyecto<span class="text-danger scale5 ms-2">*</span></label>
                                    <input type="text" class="form-control solid" placeholder="Subproyecto" aria-label="subproject" id="subproject_id" name="subproject_id" value="{{ $child->subproject->name }}">
                                </div>
                                <div class="col-xl-12 col-md-12 mb-3">
                                    <label class="form-label font-w600" for="fullname">Nombre completo<span class="text-danger scale5 ms-2">*</span></label>
                                    <input type="text" class="form-control solid" placeholder="Name" aria-label="fullname" name="fullname" id="fullname" value="{{ $child->fullname }}" >
                                </div>
                                <div class="col-xl-12 col-md-12 mb-3">
                                    <label class="form-label font-w600" for="solidarity_group_id">Grupo Solidario<span class="text-danger scale5 ms-2">*</span></label>
                                    <select class="form-select form-control solid" name="solidarity_group_id" id="solidarity_group_id">
                                        <option selected="" disabled>Elegir Grupo Solidario...</option>
                                        @foreach ($solidarity_groups as $group)
                                            <option value="{{ $group->id }}">{{ $group->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-xl-12 col-md-12 mb-3">
                                    <label class="form-label font-w600" for="tutor">Nombre del tutor o responsable<span class="text-danger scale5 ms-2">*</span></label>
                                    <input type="text" class="form-control solid" placeholder="Nombre del tutor o responsable" name="tutor" id="tutor" aria-label="tutor">
                                </div>
                                <div class="col-xl-12 col-md-12 mb-3">
                                    <label class="form-label font-w600" for="relationship">Parentesco<span class="text-danger scale5 ms-2">*</span></label>
                                    <input type="text" class="form-control solid" placeholder="Parentesco" name="relationship" id="relationship" aria-label="relationship">
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-12">
                    <div class="card">
                        {{-- <div class="card-header d-block"> --}}
                            {{-- <h4 class="fs-20 d-block"><a href="javascript:void(0);">Plan individual de beneficios</a></h4> --}}
                            {{-- <div class="d-block">
                        ...
                        <div class="card-body pt-4">
                            {{-- <select id="inputState" class="default-select form-control wide solid">
                                <option selected="" disabled>Elegir grupo solidario</option>
                                @foreach ($solidarity_groups as $group)
                                    <option value="{{ $group->id }}">{{ $group->name }}</option>
                                @endforeach
                            ...
                            <h4 class="fs-24 mb-3 text-center">Plan individual de beneficios</h4>
                            <hr>
                            <div class="row mb-3">
                                <div class="col-xl-12">
                                    <div class="col-xl-12 col-md-12 mb-3">
                                        <label class="form-label font-w600" for="goal">Por favor, escribe qué META quiere lograr la familia considerando que para alcanzarla se requerirán los recursos de tu familia y el apoyo de Unbound.<span class="text-danger scale5 ms-2">*</span></label>
                                        {{-- <input type="text" class="form-control solid" placeholder="Parentesco" name="relationship" id="relationship" aria-label="relationship"> --}}
                                        <textarea class="form-control solid" rows="20" name="goal" id="goal"></textarea>
                                    </div>
                                    <h4 class="fs-18 font-w600">Instrucciones de llenado:</h4>
                                    <p class="font-w500 mb-3">
                                        Por favor, escribe legiblemente en cada mes como invertirás los recursos de Unbound. Elige un beneficio por mes; ten presente tu META. Si en algún mes decides ahorrar, debes escribir: "ahorro", "para qué" y "en qué mes vas a gastar el ahorro".
                                    </p>
                                    <div>
                            ...
                            <div class="py-4 ">
                                ...
                                <h4 class="fs-20 font-w600">Enero</h4>
                                {{-- <span>Posted By <strong>Company</strong>/ 12-01-2021</span> --}}
                                <div class="row row-benefits border-bottom pt-3">
                                    <div class="wrap-benefits">
                                        <div class="wrap-benefit">
                                            <div class="mb-3 col-md-12">
                                                <label class="form-label">Beneficio</label>
                                                <div class="input-group">
                                                    <select class="default-select form-control wide solid" name="enero[]">
                                                        <option selected="" disabled>Elija un beneficio</option>
                                    ...
                                    <div class="col-12 mb-3 text-end">
                                        <button type="button" class="btn btn-secondary btn-sm add-benefit" data-month="enero"><i class="fas fa-plus"></i> &nbsp; Agregar beneficio</button>
                                    </div>
                                    {{-- <div class="mb-3 col-md-6">
                                        <label class="form-label">Beneficio</label>
                                        <select id="inputState" name="" class="default-select form-control wide solid">
                                            <option selected="" disabled>Elegir un beneficio</option>
                                            @foreach ($benefits as $benefit)
                                                <option value="{{ $benefit->id }}">{{ $benefit->name }}</option>
                                            @endforeach
                                        </select>
...
@section('scripts')
    ...
    <div class="wrap-benefit main-wrap d-none">
        <div class="mb-3 col-md-12">
            <label class="form-label">Beneficio</label>
            <div class="input-group">
                <select class="default-select form-control wide solid">
                    <option selected="" disabled>Elegir un beneficio</option>
                    @foreach ($benefits as $benefit)
                        <option value="{{ $benefit->id }}">{{ $benefit->name }}</option>
                    @endforeach
                </select>
                <button class="btn btn-primary btn-remove-benefit" type="button"><i class="fas fa-trash-alt"></i></button>
            </div>
        </div>
    </div>
    <script src="{{ url('js/viewlogic/benefits/add.js') }}"></script>
@endsection
