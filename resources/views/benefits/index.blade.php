...
@section('scripts')
    {{-- Customs js --}}
    <input type="hidden" id="urlList" value="{{ route('benefits.list') }}">
    <input type="hidden" id="urlGet" value="{{ route('benefits.get') }}">
    <input type="hidden" id="urlAdd" value="{{ route('benefits.add') }}">
    <input type="hidden" id="urlSave" value="{{ route('benefits.save') }}">
    <input type="hidden" id="urlDelete" value="{{ route('benefits.delete') }}">
    <script src="{{ url('js/viewlogic/benefits/index.js') }}"></script>
@endsection
