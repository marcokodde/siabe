        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    console.log(data == 1)
                    if (data == 1)
                        return `<span class="badge light badge-primary">Indicadores</span>`
                    return `<span class="badge light badge-primary">Termómetro</span>`
                }
            },
            // {
            //     targets: 2,
            ...
            //         // console.log(data == 0)
            //         if (data != null)
            //             return `<span class="badge badge-pill badge-success">Enviado</span>`
            //         return `<span class="badge badge-pill badge-warning">Sin información</span>`
            //     }
            // },
            {
                /**
