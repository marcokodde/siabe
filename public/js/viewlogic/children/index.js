(function ($) {
    ...
    var table = $('.crud-datatable').DataTable({
        ...
        columns: [
            ...
            //     name: 'DT_RowIndex'
            // },
            { data: 'child_id', name: 'child_id' },
            { data: 'fullname', name: 'fullname' },
            { data: 'child_type', name: 'child_type.name' },
            { data: 'age', name: 'age' },
            { data: 'subproject', name: 'subproject.name' },
            { data: 'child_gender', name: 'child_gender.name' },
        ...
        columnDefs: [
            ...
            // },
            {
                ...
                render: function (data, type, row, meta) {
                    return `
                    <div class="">
                        <a href="/children/benefit-plans/${row.id}" target="_blank" class="btn btn-secondary light btn-sm mr-2" data-id="${row.id}">
                            <i class="far fa-eye me-1"></i> Ver información
                        </a>
                        <!--
                        <a href="/children/benefit-plans/${row.id}" class="btn btn-danger light delete" data-id="${row.id}">
