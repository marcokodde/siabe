(function ($) {
    ...
    $('.add-benefit').click(function () {
       ...
       var wrap = $(this).closest('.row-benefits').children('.wrap-benefits')
       var main_wrap = $('.main-wrap').clone()
    //    main_wrap.
       console.log(main_wrap.children('select'))
       main_wrap.removeClass('main-wrap d-none');

    //    .attr('name', month + '[]')
       wrap.append(main_wrap)
       console.log(wrap); 
    });
    $('.wrap-benefits').on('click','.btn-remove-benefit', function () {
        var btn_remove = $(this)
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                remove_benefit(btn_remove)
            }
        })
    });
    function wrap_benefit(wrap) {
        
    }
    function get_content_wrap() {
        return `
    ...
    function remove_benefit(btn_remove) {
        $(btn_remove).closest('.wrap-benefit').remove()
    }
