...
(function($) {
 ...
 var dlabChartlist = function(){
	...
	var activityBar1 = function(){
		var url = $('#urlstatistics').val()
		$.ajax({
            url: url,
            type: 'GET',
            data: {category: $('#category-kpi').val() },
            dataType: 'json',
            success: function (result) {
                console.log(result)
				for (let index = 0; index < result.kpis.length; index++) {
					const element = result.kpis[index];
					if($('#kpi-file_name').val() == element.field_name) {
						var activity1 = document.getElementById("activity1");
						if (activity1 !== null) {
							activity1.height = 300;
	...
	var activityBar2 = function(){
		var url = $('#urlstatistics').val()
		$.ajax({
            url: url,
            type: 'GET',
            data: {category: $('#category-kpi-ther').val() },
            dataType: 'json',
            success: function (result) {
                console.log(result)
				result.kpis.forEach(element => {
					if ($('#kpi-file_name-ther').val() == element.field_name) {
						console.log(true);
						var activity1 = document.getElementById("activity2");
						if (activity1 !== null) {
							activity1.height = 300;
	...
	var activityBar3 = function(){
		var url = $('#urlkpis').val()
		$.ajax({
            url: url,
            type: 'GET',
            data: {kpi: 'payroll_credit'},
            dataType: 'json',
            success: function (result) {
                console.log(result)
				var activity1 = document.getElementById("activity3");
				if (activity1 !== null) {
					activity1.height = 300;
					...
					var ctx = document.getElementById("activity3").getContext("2d");
					var myLine = new Chart(ctx, config);
	...
	var activityBar4 = function(){
		var url = $('#urlkpis').val()
		$.ajax({
            url: url,
            type: 'GET',
            data: {kpi: 'personal_credit'},
            dataType: 'json',
            success: function (result) {
                console.log(result)
				var activity1 = document.getElementById("activity4");
				if (activity1 !== null) {
					activity1.height = 300;
					...
					var ctx = document.getElementById("activity4").getContext("2d");
					var myLine = new Chart(ctx, config);
